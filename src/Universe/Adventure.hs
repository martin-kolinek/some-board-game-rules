...
data AdventureReward = WoodReward | GrassReward | SmallPastureReward | SheepReward | LargePastureReward | BarnReward
...
rewardInteraction BarnReward = Just $ InteractionAction BuildBarnInteraction []
